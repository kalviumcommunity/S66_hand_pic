...
const SignUp = () => {
    ...
    const loginWithGoogle = useGoogleLogin({
        onSuccess: async (tokenResponse) => {
            try {
                ...
                if (result.success) {
                    if (result.isNewUser) {
                        toast.success("Google account linked! Please complete your profile details.");
                    } else {
    ...
    return (
        <div className="flex flex-col lg:flex-row h-screen overflow-hidden bg-white relative">
            ...
            {/* LEFT PANEL: Decorative Ambient Side (Synced with Login) */}
            <div className="hidden lg:flex flex-1 relative bg-[#fef2f2] overflow-hidden flex-col px-16 py-10 justify-center">
                    ...
                    >
                        ...
                        >
                            ...
                            <span className="text-xs font-semibold text-slate-700">Join an artistic photography stream</span>
                        </motion.div>
                        ...
                        >
                            Express view through<br/>hand artistry.
                        </motion.h1>
                        ...
                        >
                            Start your own curation collection. Establish valid perspective stats, archive personal captures and construct recognition in the visual arena.
                        </motion.p>
                        ...
                        >
                            <div className="flex items-center space-x-2 bg-white/80 backdrop-blur px-4 py-2 rounded-full shadow-sm border border-slate-100">
                                ...
                                <span className="text-sm font-bold text-slate-800">Global Gallery</span>
                            </div>
                            <div className="flex items-center space-x-2 bg-white/80 backdrop-blur px-4 py-2 rounded-full shadow-sm border border-slate-100">
                                <svg className="w-4 h-4 text-teal-500" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd"/></svg>
                                <span className="text-sm font-bold text-slate-800">Interactive Feed</span>
                            </div>
                        </motion.div>

                        {/* Path illustration mirrored style */}
                        <motion.div 
                        ...
                        >
                            <motion.div 
                                ...
                                className="absolute bottom-4 left-4 flex items-center space-x-2 bg-white/90 backdrop-blur-md px-3 py-1.5 rounded-full shadow-sm border border-slate-100"
                            >
                                ...
                                <span className="text-xs font-bold text-slate-800">Identity Initialized</span>
                            </motion.div>
                            
                            <motion.svg className="w-full h-full rotate-180 transform scale-y-[-1]" viewBox="0 0 400 150" fill="none" preserveAspectRatio="none">
                                <motion.path 
                                    d="M 10 120 Q 50 120, 100 75 T 200 100 T 350 50" 
                                    stroke="url(#gradientPathSignUp)" 
                                    strokeWidth="12" 
                                    strokeLinecap="round" 
                                    opacity="0.2" 
                                ...
                                />
                                <defs>
                                    <linearGradient id="gradientPathSignUp" x1="0%" y1="0%" x2="100%" y2="0%">
                ...
                <div className="flex-1 flex items-center justify-center px-6 sm:px-12 bg-white overflow-y-auto h-full">
                    ...
                    >
                        ...
                        >
                            Begin establishing your curated presence today.
                        </motion.p>
                        ...
                        >
                            ...
                            <div className="text-center pt-6">
                                <p className="text-slate-400 text-[11px] leading-relaxed">
                                    By signing up, you agree to our <a href="#" className="text-slate-500 hover:underline">Terms of Service</a> and <a href="#" className="text-slate-500 hover:underline">Privacy Policy</a>.
                                </p>
                            </div>
                        </motion.form>
                    </motion.div>
