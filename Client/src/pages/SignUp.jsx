        ...
        <div className="flex flex-col lg:flex-row min-h-screen lg:h-screen lg:overflow-hidden bg-white relative">
            ...
            <div className="hidden lg:flex flex-1 relative bg-slate-955 overflow-hidden flex-col px-16 py-10 justify-center text-slate-100">
                    ...
                    >
                        ...
                        >
                            Start your own curation collection.
                            Publish personal captures, check platform timelines, and register visual appreciation.
                        </motion.p>
                        ...
                        >
                            <div className="flex items-center space-x-1.5 bg-slate-900 border border-slate-850 px-3 py-1.5 rounded-md shadow-sm">
                                ...
                                <span className="text-xs font-semibold text-slate-355">Global Gallery</span>
                            </div>
                            <div className="flex items-center space-x-1.5 bg-slate-900 border border-slate-850 px-3 py-1.5 rounded-md shadow-sm">
                                <svg className="w-3.5 h-3.5 text-slate-400" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd"/></svg>
                                <span className="text-xs font-semibold text-slate-355">Interactive Feed</span>
                            </div>
                        </motion.div>
                    </motion.div>
                </div>
                ...
                <div className="flex-1 flex flex-col justify-center items-center px-6 sm:px-12 bg-white min-h-screen lg:h-full lg:overflow-y-auto">
                    ...
                    >
                        ...
                        <motion.h2 
                            ...
                            className="text-2xl font-extrabold text-slate-955 tracking-tight mb-1"
                        >
                            Create your account
                        </motion.h2>
                        <motion.p 
                        ...
                        >
                            <div className="space-y-1.5">
                                ...
                                <input
                                    ...
                                    className="w-full px-3 py-2 text-sm bg-white border border-slate-200 rounded-md text-slate-950 placeholder-slate-400 focus:outline-none focus:ring-1 focus:ring-slate-955 focus:border-slate-955 transition-all font-medium"
                                    required
                                />
                            </div>
                            ...
                            <div className="space-y-1.5">
                                ...
                                <PasswordInput
                                    ...
                                    className="w-full px-3 py-2 text-sm bg-white border border-slate-200 rounded-md text-slate-950 placeholder-slate-400 focus:outline-none focus:ring-1 focus:ring-slate-955 focus:border-slate-955 transition-all font-medium pr-10"
